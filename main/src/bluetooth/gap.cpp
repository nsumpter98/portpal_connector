...
Gap::Gap()
{
    ESP_LOGI("GAP", "initialize");
}

void Gap::advertizing_init(void)
{
    int rc = 0;
    char addr_str[18] = {0};
...
// private methods
void Gap::print_conn_desc(struct ble_gap_conn_desc *desc)
{
    /* Local variables */
    char addr_str[18] = {0};
...
void Gap::start_advertising(void)
{
    /* Local variables */
    int rc = 0;
    const char *name;
